...
@regist_dataset
class Green(DenoiseDataSet):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.dataset_path = os.path.join('D:\python-learning\AP-BSN\dataset\\green');

    def _scan(self):
        # check if the dataset exists
        dataset_path = os.path.join('D:\python-learning\AP-BSN\dataset\\green');
