...
@regist_dataset
class Mosaic(DenoiseDataSet):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.dataset_path = os.path.join('D:\python-learning\AP-BSN\dataset\\mosaic');

    def _scan(self):
        # check if the dataset exists
        dataset_path = os.path.join('D:\python-learning\AP-BSN\dataset\\mosaic');
